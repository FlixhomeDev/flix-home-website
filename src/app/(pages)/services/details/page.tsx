  ...
  const data = [
    {
      ...
      items: [
        {
          title: "Limpeza do Pó em todas as divisões",
  ...
  return (
    <div className="flex flex-col">
      <div className="hidden w-full md:flex items-center gap-[5px] px-[100px]  mt-[48px] md:mt-[120px]">
        <span className="text-sm text-[#9497A1] font-medium font-manrope">
          Serviços
        </span>
        <div className="bg-[#9497A1] w-[1.5px] h-[14px]" />
        <span className="text-sm text-[#292D33] font-semibold font-manrope">
          Details
        </span>
      </div>
            ...
            <div className="flex items-center gap-2 w-full h-[50%]">
              ...
              <div className="w-[50%] h-full rounded-tr-[16px]">
                <Image
                  src={ServiceDetails3}
                  alt="service details"
                  className="w-full h-full object-cover rounded-tr-[16px]"
                />
              </div>
            </div>
            <div className="flex items-center gap-2 w-full h-[48%]">
              ...
              <div className="w-[50%] h-full rounded-br-[16px]">
                <Image
                  src={ServiceDetails5}
                  alt="service details"
                  className="w-full h-full object-cover rounded-br-[16px]"
                />
              </div>
            </div>
          </div>
      ...
      <div className="mt-10 w-full md:px-[100px] flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="w-[340px] flex flex-col items-start justify-start md:hidden">
          <div className="w-full h-[1px] border border-[#E5E7EB] mt-5" />
          <p className="w-full text-[13px] md:text-base text-[#6F6F6F] font-normal font-inter mt-[10px]">
            Nota: São utilizadas técnicas de limpeza profunda com recurso a
            equipamentos de injecção e extracção de água. Tempo de secagem de 3
            a 8 horas, dependendo das condições climatéricas. A chaise longue
            equivale a um lugar extra.
          </p>
        </div>
          ...
          <div className="w-full h-[215px] border border-[#E5E7EB] rounded-[7px] p-[23px] bg-[#FFFFFF] shadow-[0px_9.7px_9.7px_rgba(31,41,55,0.04),0px_19.39px_24.24px_rgba(31,41,55,0.1)]">
            <div className="bg-[#3C91E6] shadow-[#1F293714] px-[15px] py-[11px] rounded-[7px] w-full h-[43px] flex items-center justify-center">
              <Link
                ...
                target="_blank"
                className="md:text-[13px] text-sm text-[#FFFFFF] font-medium font-inter"
              >
                Agendar Serviço
              </Link>
            </div>
            ...
            <div className="w-full h-[1px] border border-[#E5E7EB] my-[15px]" />
            <div className="w-full flex items-center justify-between mt-[7px]">
          ...
          <div className="mt-[23px] flex items-center justify-center gap-[7px]">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <button
                  type="button"
                  className="md:text-[13px] text-sm text-[#6B7280] font-normal font-inter border-b border-[#6B7280]"
                >
                  Denunciar
                </button>
              </DialogTrigger>
      ...
      <div className="hidden md:flex md:flex-col w-full px-[100px]">
        <div className="w-[670px] h-[1px] border border-[#E5E7EB] my-5" />
        <p className="w-[670px] text-base text-[#6F6F6F] font-normal font-inter mt-[32px]">
          Nota: São utilizadas técnicas de limpeza profunda com recurso a
          equipamentos de injecção e extracção de água. Tempo de secagem de 3 a
          8 horas, dependendo das condições climatéricas. A chaise longue
          equivale a um lugar extra.
        </p>
        <div className="w-[670] h-[1px] border border-[#E5E7EB] my-[32px]" />
        <div className="w-[670] h-[1px] border border-[#E5E7EB] mb-[32px]" />
      </div>
