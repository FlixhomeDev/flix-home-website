  ...
  return (
    ...
    <div
      ...
      <h4 className="flex items-center gap-[2.65px] mt-[13px]">
        <span className="text-[#3C91E6] text-[13px] md:text-[17px] font-semibold font-inter leading-[15.73px] md:leading-[20.87px] -tracking-[0.2px]">€ {newPrice}</span>
      ...
      <p className="text-[#484848] text-[10px] md:text-[13px] font-medium font-inter leading-[12.1px] md:leading-[16.05px] -tracking-[0.2px] mt-[6px]">{title}</p>
      <Link href={"https://wa.me/message/PHDJAIL6RKWZC1"}
        className="md:h-[37.22px] h-[28px] w-[120px] md:w-[145.77px] flex items-center gap-[10px] md:gap-[5.31px] py-[8px] px-[9px] md:py-[11px] md:px-[10px] border border-[#3C91E614] border-opacity-[8%] bg-[#3C91E605] bg-opacity-[2%] rounded-[7px] mt-4 text-[#3C91E6] text-[10px] md:text-[13px] font-medium font-inter leading-[12.1px] md:leading-[16.05px] -tracking-[0.2px]"
      >
