  ...
  const dataPlans = [
    {
      ...
      items: [
        {
          title: "Até 3 ativos cobertos",
          example: "(ex: Ar-condicionado, Eletrodomésticos, Canais Hidráulicos)",
