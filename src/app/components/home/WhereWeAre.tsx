  ...
  return (
    <Dialog>
      ...
      <DialogContent className='max-w-[400px] w-full'>
        <DialogHeader>
          <DialogTitle className="hidden">Estamos localizados em varias zonas de Portugal</DialogTitle>
          <DialogDescription className="flex flex-col gap-y-2 mx-auto pb-4" />
        </DialogHeader>
        <div className="flex flex-col items-center justify-center gap-y-4">
          <Image src={MapPinned} alt="MapPinned" width={150} />
          <h4 className="text-center font-bold">Estamos localizados em varias zonas de Portugal</h4>
