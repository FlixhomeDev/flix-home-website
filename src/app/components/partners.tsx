  ...
  return (
    <div className="w-full flex items-center flex-col  pt-8 lg:flex-row px-8 mt-[180px] gap-[94px] md:px-[112px] mx-auto justify-between">
      ...
      <div className="flex flex-col gap-6 items-center">
        <div className="p-5 h-[112px] rounded-[22px] flex justify-between items-center w-[500px] border border-secondaryColor hover:shadow-md transition-all">
        ...
        <div className="">
          <div className="flex p-5 rounded-[22px] flex-col gap-1 w-[500px] border border-primaryColor/30 shadow-lg">
            <div className="flex items-center gap-1">
              ...
              <span className="text-primaryColor text-[24px] font-bold">
                Limpeza para sua casa
              </span>
            </div>
            <div className="flex items-center gap-1">
              <CircleCheck className="text-gray-300 text-[26px]" />
              <span className="text-gray-300 text-[24px] font-bold">
