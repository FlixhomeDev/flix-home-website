...
export function AccordionFaqs() {
  return (
    <Accordion type="single" collapsible className="w-full mt-[50px]">
      <AccordionItem
        value="item-1"
        className="px-[40px] py-4 lg:py-[24px] border-[3px] border-gray-400 rounded-xl mb-6"
      >
      ...
      <AccordionItem
        value="item-4"
        className="px-[40px] py-4 lg:py-[24px] border-[3px] border-gray-400 rounded-xl"
      >
        <AccordionTrigger className="text-base lg:text-[24px] text-left text-[#3D3D3D]">
          Posso reagendar o serviço?
        </AccordionTrigger>
        <AccordionContent className="text-sx lg:text-base text-gray-400">
          Yes. It&apos;s animated by default, but you can disable it if you
          prefer.
