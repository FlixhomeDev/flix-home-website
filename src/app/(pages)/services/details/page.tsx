...
export default function Details() {
  ...
  //         `https://flix-home-app-api-production.up.railway.app/service/${id}`
  //       );
  ...
  useEffect(() => {
    const data = sessionStorage.getItem("serviceDetails");
    if (data) setServiceData(JSON.parse(data));
  }, []);
      ...
      <div className="mt-10 w-full md:px-[100px] flex flex-col md:flex-row items-center justify-between">
        <div>
          ...
          <ListItems
            ...
            itemsnotinclud={data?.flatMap((i) => i.itemsnotinclud) || []}
          />
        </div>
          ...
          <div className="mt-[23px] flex items-center justify-center gap-[7px]">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <button className="md:text-[13px] text-sm text-[#6B7280] font-normal font-inter border-b border-[#6B7280]">
                  Denunciar
                </button>
              </DialogTrigger>
              <ReportDialog />
