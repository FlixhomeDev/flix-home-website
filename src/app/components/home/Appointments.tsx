...
export function Appointments() {
  ...
  return (
    <div className="max-w-[1256px] w-full mx-auto mt-[135px] lg:mt-24 2xl:mt-64 px-4 md:px-8 overflow-hidden">
      ...
      <div className="w-full justify-normal items-center mt-[26px] flex">
        <div className="max-w-[712px] w-full mx-auto h-[75px] py-[14px] px-[16px] bg-[#FFFFFF] shadow-[#090B2105] flex flex-row justify-center items-center gap-5">
          <motion.div
