...
export default function StartNow() {
  return (
    <div className="w-full mt-5 md:mt-24 2xl:mt-64 flex items-center justify-center flex-col gap-y-4 px-4 md:px-8">
      ...
      <Link
        ...
        target="_blank"
        className="bg-[#3C91E6] w-[124px] md:w-[166px] h-[30px] md:h-[41px] mt-[15px] md:mt-[30px] rounded-[5px] flex items-center gap-[7px] md:gap-[10px] py-[9px] px-[7px] md:py-3 md:px-[10px] text-[#FFFFFF] text-[10px] md:text-sm font-medium font-inter leading-[12.71px] md:leading-[16.94px]"
      >
        Experimente agora
