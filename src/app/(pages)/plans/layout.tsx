...
export const metadata: Metadata = {
  title: "Flix Home | Planos de Manutenção Residencial a Partir de 0€",
  description:
    "Planos de manutenção preventiva para ativos residenciais, desde diagnósticos grátis a proteção total.",
  keywords: [
